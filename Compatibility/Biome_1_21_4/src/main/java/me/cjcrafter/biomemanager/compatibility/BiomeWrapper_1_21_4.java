...
public class BiomeWrapper_1_21_4 implements BiomeWrapper {
    ...
    public BiomeWrapper_1_21_4(Biome biome) {
    ...
    public BiomeWrapper_1_21_4(NamespacedKey key, BiomeWrapper_1_21_4 base) {
        this.key = key;
